...
if (isset($_GET['delete'])) {
    ...
    $stmt->execute();
    $stmt->close();
    header("Location: student2.php"); // refresh
    exit;
}
...
<body>
    <h2>📚 Manage Books (Edit / Remove)</h2>
    <table>
        <tr>
            <th>ISBN</th>
            <th>Title</th>
        ...
        <tr>
            <form method="post" action="student2.php">
                ...
                <td>
                    ...
                    <a href="student2.php?delete=<?= $row['isbn_num'] ?>" onclick="return confirm('Delete this book?')">Delete</a>
                </td>
            </form>
        </tr>
        <?php endwhile; ?>
